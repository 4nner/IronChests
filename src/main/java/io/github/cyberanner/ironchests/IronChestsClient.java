...
public class IronChestsClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ClientSpriteRegistryCallback.event(TexturedRenderLayers.CHEST_ATLAS_TEXTURE).register((texture, registry) -> {
            registry.register(new Identifier(IronChests.MOD_ID, "model/copper_chest"));
            registry.register(new Identifier(IronChests.MOD_ID, "model/iron_chest"));
            registry.register(new Identifier(IronChests.MOD_ID, "model/gold_chest"));
            registry.register(new Identifier(IronChests.MOD_ID, "model/diamond_chest"));
            registry.register(new Identifier(IronChests.MOD_ID, "model/crystal_chest"));
            registry.register(new Identifier(IronChests.MOD_ID, "model/obsidian_chest"));
            registry.register(new Identifier(IronChests.MOD_ID, "model/dirt_chest"));
        });
    }
}
