...
public class ModItems {
    ...
    public static void registerItems() {
        ...
        Registry.register(Registry.ITEM, new Identifier(IronChests.MOD_ID, "wood_gold_upgrade"), WOOD_GOLD_UPGRADE);
        Registry.register(Registry.ITEM, new Identifier(IronChests.MOD_ID, "wood_diamond_upgrade"), WOOD_DIAMOND_UPGRADE);
        Registry.register(Registry.ITEM, new Identifier(IronChests.MOD_ID, "wood_emerald_upgrade"), WOOD_EMERALD_UPGRADE);
        Registry.register(Registry.ITEM, new Identifier(IronChests.MOD_ID, "wood_crystal_upgrade"), WOOD_CRYSTAL_UPGRADE);
        Registry.register(Registry.ITEM, new Identifier(IronChests.MOD_ID, "wood_obsidian_upgrade"), WOOD_OBSIDIAN_UPGRADE);

        Registry.register(Registry.ITEM, new Identifier(IronChests.MOD_ID, "copper_iron_upgrade"), COPPER_IRON_UPGRADE);
        Registry.register(Registry.ITEM, new Identifier(IronChests.MOD_ID, "copper_gold_upgrade"), COPPER_GOLD_UPGRADE);
        Registry.register(Registry.ITEM, new Identifier(IronChests.MOD_ID, "copper_diamond_upgrade"), COPPER_DIAMOND_UPGRADE);
        Registry.register(Registry.ITEM, new Identifier(IronChests.MOD_ID, "copper_emerald_upgrade"), COPPER_EMERALD_UPGRADE);
        Registry.register(Registry.ITEM, new Identifier(IronChests.MOD_ID, "copper_crystal_upgrade"), COPPER_CRYSTAL_UPGRADE);
        Registry.register(Registry.ITEM, new Identifier(IronChests.MOD_ID, "copper_obsidian_upgrade"), COPPER_OBSIDIAN_UPGRADE);

        Registry.register(Registry.ITEM, new Identifier(IronChests.MOD_ID, "iron_gold_upgrade"), IRON_GOLD_UPGRADE);
        Registry.register(Registry.ITEM, new Identifier(IronChests.MOD_ID, "iron_diamond_upgrade"), IRON_DIAMOND_UPGRADE);
        Registry.register(Registry.ITEM, new Identifier(IronChests.MOD_ID, "iron_emerald_upgrade"), IRON_EMERALD_UPGRADE);
        Registry.register(Registry.ITEM, new Identifier(IronChests.MOD_ID, "iron_crystal_upgrade"), IRON_CRYSTAL_UPGRADE);
        Registry.register(Registry.ITEM, new Identifier(IronChests.MOD_ID, "iron_obsidian_upgrade"), IRON_OBSIDIAN_UPGRADE);
        ...
        Registry.register(Registry.ITEM, new Identifier(IronChests.MOD_ID, "gold_crystal_upgrade"), GOLD_CRYSTAL_UPGRADE);
        Registry.register(Registry.ITEM, new Identifier(IronChests.MOD_ID, "gold_obsidian_upgrade"), GOLD_OBSIDIAN_UPGRADE);
