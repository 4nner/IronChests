...
public class ModItems {
    ...
    // Items
    public static final Item WOOD_COPPER_UPGRADE = new Item(new Item.Settings().group(ItemGroup.MISC));

    // Block Items
    public static final BlockItem COPPER_CHEST = new BlockItem(ModBlocks.COPPER_CHEST, new Item.Settings().group(ItemGroup.DECORATIONS));
